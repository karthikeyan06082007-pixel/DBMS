...
mysql> CREATE TABLE EMPLOYEE
    ...
    -> E_name VARCHAR(50), E_address VARCHAR(100), E_ph_no VARCHAR(15), Dept_no INT, Dept_name VARCHAR(50), Job_id CHAR(10), Salary DECIMAL(10, 2));
...
mysql> INSERT INTO EMPLOYEE
    -> (E_no, E_name, E_address, E_ph_no, Dept_no,Dept_name, Job_id, Salary, HIREDATE)VALUES (1, 'John Doe', '123 Main St', '555-1234', 101, 'Sales', 'J1001', 50000.00, '20-08-24');
Query OK, 1 row affected (0.12 sec)

mysql> INSERT INTO EMPLOYEE
    -> (E_no, E_name, E_address, E_ph_no, Dept_no,
    -> Dept_name,
    -> Job_id, Salary, HIREDATE)VALUES (2, 'Jane Smith', '456 Oak St', '555-5678',102, 'Marketing', 'J1002', 60000.00, '4-06-18');
Query OK, 1 row affected (0.11 sec)

mysql> INSERT INTO EMPLOYEE
    -> (E_no, E_name, E_address, E_ph_no, Dept_no,Dept_name,
    -> Job_id, Salary, HIREDATE)VALUES (3, 'Alice Johnson', '789 Pine St', '555-9012', 103, 'HR', 'J1003', 55000.00, '4-07-15');
Query OK, 1 row affected (0.12 sec)

mysql> INSERT INTO EMPLOYEE
    -> (E_no, E_name, E_address, E_ph_no, Dept_no,Dept_name,
    -> Job_id, Salary, HIREDATE)VALUES (4, 'Alice Bob', '112 Apple St', '555-1112',104, 'ADMIN', 'J1004', 45000.00, '4-03-15');
...
|    3 | Alice Johnson | 789 Pine St  | 555-9012 |     103 | HR        | J1003  | 55000.00 | 0004-07-15 |
...
mysql> UPDATE EMPLOYEE SET
    -> Dept_name = 'Digital Marketing' WHERE
    -> Dept_no = 102;
Query OK, 1 row affected (0.13 sec)
Rows matched: 1  Changed: 1  Warnings: 0
